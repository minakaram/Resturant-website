...
import img4 from "./images/louis-hansel-cH5IPjaAYyo-unsplash.jpg";
import img5 from "./images/louis-hansel-rheOvfxOlOA-unsplash.jpg";
import img6 from "./images/farhad-ibrahimzade-ZipYER3NLhY-unsplash.jpg";
...
function Menu() {
  return (
    <div className="menu-header">
      <div className="menus">
        <h1>Our Menues</h1>
        <p>Perfect For all Beakfast, Lunch and Dinner</p>
      </div>
